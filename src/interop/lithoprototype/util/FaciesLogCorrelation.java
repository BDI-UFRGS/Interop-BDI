...
public class FaciesLogCorrelation {
    ...
    */
    ...
    public int getNumberOfSamples()
    {
        ...
        LogValues anyLogValueList = anyWellLog.getLogValues();
    ...
    private List<WellLog> sliceWellLog(ParsedLAS parsed)
    {
        ...
        for(WellLog wl:wellLogs)
        {
            ...
            slicedWellLog.getLogType().setLogMeasureUnit(wl.getLogType().getLogMeasureUnit());
            slicedWellLog.getLogType().setLogDescription(wl.getLogType().getLogDescription());
            slicedWellLog.setNullValue(wl.getNullValue());
            
            LogValues slicedLVL = new LogValues();
            slicedLVL.putAll(wl.getLogValues().subMapByIndex(startIndex, stopIndex));
